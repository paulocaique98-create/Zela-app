...
// CAREFULLY capture the correct handleSubmit
const submitStart = code.indexOf('  const handleSubmit = async (e) => {');
const fieldFnIndex = code.indexOf('  const field =', submitStart);
const oldSubmit = code.substring(submitStart, fieldFnIndex);
...
const formContentStart = code.indexOf('  const formContent = (');
const section2Index = code.indexOf('      {/* ── SEÇÃO 2: DADOS DO RESPONSÁVEL ── */}', formContentStart);
const oldFormContent = code.substring(formContentStart, section2Index);
