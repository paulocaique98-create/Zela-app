-- approve_matricula passa a persistir cidade_nascimento e as autorizações
-- de imagem/emergência médica (colunas novas em students, ver migração
-- 20260923c) -- antes esses dados eram coletados no formulário e
-- descartados na aprovação, nunca chegavam a lugar nenhum.
