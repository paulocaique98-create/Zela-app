...
import { ShieldCheck, Bell, LogOut, Menu } from 'lucide-react';
      ...
      <div className="flex justify-end items-center gap-3 flex-1">
        ...
        {currentUser.role === 'family' && (
          <div className="flex items-center gap-1 md:gap-3 mr-1 md:mr-2 border-r border-slate-200 pr-4">
            <button className="relative p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition" title="Notificações">
              <Bell size={18} />
